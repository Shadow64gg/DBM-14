module.exports = {
  ...
  meta: {
    ...
    downloadURL:
      "https://github.com/dbm-network/mods/blob/master/actions/canvas_image_filter_MOD.js",
  },
...
<div style="padding-top: 8px;">
  ...
  init() {
    ...
    glob.onChange1 = function onChange1(event) {
      ...
      if (value === 1) {
        valuetext.innerHTML =
          '<span class="dbminputlabel">Value (Degree)</span>';
      } else {
        valuetext.innerHTML =
          '<span class="dbminputlabel">Value (Percent)</span>';
      }
    };
