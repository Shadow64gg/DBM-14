const Mods = {
  ...
  getWebhook(type, varName, cache) {
    ...
    switch (type) {
      ...
      case 2:
        if (server && this.DBM.Actions.server[server.id])
          return this.DBM.Actions.server[server.id][varName];
        break;
      case 3:
...
module.exports = {
  ...
  meta: {
    ...
    downloadUrl:
      "https://github.com/dbm-network/mods/blob/master/actions/aaa_dbmmods_dependencies_MOD.js",
  },
